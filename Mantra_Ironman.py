...
mantra.append("Son horas que vivo con alegría, porque son genuinamente mías y no las comparto con nadie. Es mi vivencia personal, genuina, intransferible y quiero disfrutar de ella.")
mantra.append("El objetivo más importante es llegar a la meta, la planificación está en un segundo lugar y el objetivo de la planificación es alcanzar un mejor rendimiento.")
